...
function Icon(props) {
    const {color = '#ffc107', isFavorite, className, art, toggleLocalStorage, localStorageKey} = props;
    return (
        <svg onClick={()=> toggleLocalStorage(localStorageKey, art)} className={className} viewBox='0 0 16 17' width='16' height='17' xmlns='http://www.w3.org/2000/svg'>
            <path
                ...
                stroke={color} fill={isFavorite ? color : 'white'}
            />
        </svg>
    );
}
